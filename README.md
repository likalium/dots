...
## :notes: Mpd & Ncmpcpp
<details>
The [Mpd config](./mpd) and [Ncmpcpp config](./ncmpcpp) works together. I mean, you can use the Mpd config with another client, there's no problem, but this Mpd config was made for Mpd. That's all.
## Requirements
- Mpd
- Ncmpcpp
### Useful infos
